...
-- orphaned reservation while that child is still alive. Process start times
-- make PID reuse detectable; nullable identities keep launch available if the
-- host cannot supply one, while recovery stays conservative.
